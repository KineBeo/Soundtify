...
const HorizontalArtistList = dynamic(() => import('@/components/artist/HorizontalArtistList'));
const HorizontalSongsList = dynamic(() => import('@/components/song/HorizontalSongsList'));
const ReduxStateUpdater = dynamic(() => import('@/components/ReduxStateUpdater'));
async function getHomePageData() {
  const artistsResponse = await fetch('https://soundtify.onrender.com/artist/all-artists');
  const tracksResponse = await fetch('https://soundtify.onrender.com/tracks/all-tracks');
